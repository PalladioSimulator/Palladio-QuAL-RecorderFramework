...
/**
 * This class holds meta data that an aggregation recorder should use to provide it's write strategy
 * with initializing meta information.
 * 
 * @author Baum
 * 
 */
public class AggregationMetaDataInit {
     ...
     *            The index of the metric that the aggregation is performed on in the measurement
     *            metric vector.
     * 
     */
    ...
    /**
     * Returns the index of the aggregated metric in the measurement metric vector.
     * 
    ...
    /**
     * Returns whether the aggregation is valid, i.e. consistent with raw measurements.
     * 
    ...
    /**
     * Sets whether the aggregation is valid, i.e. consistent with raw measurements.
     * 
     * @param isValid
     ...
     *            The description of the aggregation function.
     */
    public void setAggregationFunctionDescription(String aggregationFunctionDescription) {
